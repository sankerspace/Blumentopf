...
%The ATMega offers multiple ADC modes for sampling analog signals. The most accurate one is to use the analog signal as reference voltage and the internal voltage regulator of the ADC unit as the voltage to measure. This is a 
